...
import type { JourneyEntry } from "@/constants/content";
 ...
 * Entries come from the server component, which merges the curated narrative
 * with project milestones from the live GitHub repos.
 */
    ...
    >
      <div className="mx-auto max-w-6xl px-6 py-28 md:py-40">
        ...
        <ol ref={ref} className="relative ml-1 max-w-2xl">
          ...
          {entries.map((entry, i) => (
            <motion.li
              key={`${entry.year}-${entry.title ?? "future"}`}
